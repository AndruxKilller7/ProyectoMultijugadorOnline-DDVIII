...
namespace MyCrudGame.Controllers
{
    public class SkinsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,Code, Value,Disponible")] Skin skin)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,Code, Value,Disponible")] Skin skin)
        {
            if (id != skin.Id)
            {
                return NotFound();
